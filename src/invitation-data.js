export const invitationData = {
  ...
  hero: {
    image: "./assets/images/half/hero.jpg?v=20260505-half-photos",
  ...
  spotlight: {
    ...
    image: "./assets/images/half/gallery-04.jpg?v=20260505-half-photos",
    ...
    apps: [
      {
        label: "네이버지도",
        caption: "앱에서 열기",
        iconSrc: "./assets/images/네이버지도.webp?v=20260418-user-source",
        brand: "naver",
        type: "app",
      ...
      },
      {
        label: "티맵",
        caption: "앱 길찾기",
        iconSrc: "./assets/images/T맵.svg?v=20260418-user-source",
        brand: "tmap",
        type: "app",
      ...
      },
      {
        label: "카카오맵",
        caption: "앱에서 보기",
        iconSrc: "./assets/images/카카오네비.png?v=20260418-user-source",
        brand: "kakao",
        type: "app",
